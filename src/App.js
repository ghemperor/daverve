...
function ProductDetailPage({ products, onAddToCart }) {
  ...
  // UI
  return (
    <div className="min-h-screen bg-white flex justify-center" style={{paddingTop: '5vh'}}>
      <div className="w-full md:max-w-[75vw] px-0 sm:px-0 md:px-0 flex flex-col md:flex-row items-center gap-4 md:gap-12 overflow-y-auto" style={{height: 'calc(100vh - 5vh)'}}>
