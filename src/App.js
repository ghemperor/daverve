...
function ProductDetailPage({ products, onAddToCart }) {
  ...
  return (
    <div className="min-h-screen bg-white pt-16 pb-12 flex justify-center">
      <div className="w-full max-w-[80vw] px-0 sm:px-0 md:px-0 flex flex-col md:flex-row items-center gap-4 md:gap-12 overflow-y-auto" style={{height: 'calc(100vh - 7rem)'}}>
